...
Generated at: 2026-02-28T22:27:51.214294+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        "name": "register_user_for_tests",
        "category": "SETUP",
        "endpoint": "/auth/register",
        "method": "POST",
        "description": "Register a test user to use for subsequent authenticated tests",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/auth/token",
        "method": "POST",
        "description": "Authenticate with valid credentials and receive a JWT access token",
        "setup": {
            "endpoint": "/auth/register",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/auth/token",
        "method": "POST",
        "description": "Attempt to login with incorrect password, expect 401",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/add",
        "method": "POST",
        "description": "Add two numbers with valid auth token",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/subtract",
        "method": "POST",
        "description": "Subtract two numbers with valid auth token",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/subtract",
        "method": "POST",
        "description": "Subtract where result is negative to test negative number handling",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/multiply",
        "method": "POST",
        "description": "Multiply two numbers with valid auth token",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/multiply",
        "method": "POST",
        "description": "Multiply by zero to test edge case",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/divide",
        "method": "POST",
        "description": "Divide two numbers with valid auth token",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    {
        "name": "create_calculation_add",
        "category": "HAPPY_PATH",
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Create a persisted add calculation and verify 201 response",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    {
        "name": "create_calculation_div",
        "category": "HAPPY_PATH",
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Create a persisted div calculation and verify 201 response",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "GET",
        "description": "List all calculations with valid auth token",
        "request_data": {
            "path": {},
            "query": {},
            "body": null,
    ...
    },
    {
        ...
        "endpoint": "/calculations/{calculation_id}",
        "method": "DELETE",
        "description": "Create a calculation and then delete it, expect 204",
        "setup": {
            "endpoint": "/calculations",
            "method": "POST",
            "body": {

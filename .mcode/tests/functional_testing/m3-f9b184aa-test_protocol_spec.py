...
TEST_CASES = json.loads(r'''[
    {
        ...
        "method": "POST",
        "description": "Create a new calculation with a valid 'add' operation and verify 201 response with full calculation record",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Attempt to create a division calculation with b=0 and expect 400 error with 'Cannot divide by zero' message",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "GET",
        "description": "List all calculations. Creates a calculation first to ensure the list is non-empty, then verifies 200 response with array.",
        "request_data": {
            "path": {},
            "query": {},
            "body": null,
    ...
    },
    {
        ...
        "endpoint": "/calculations/{calculation_id}",
        "method": "GET",
        "description": "Create a calculation, retrieve it by ID, then delete it. Verifies 200 response with the correct calculation record.",
        "request_data": {
            "path": {
                "calculation_id": "$setup_id"
            },
    ...
    },
    {
        ...
        "endpoint": "/calculations/{calculation_id}",
        "method": "DELETE",
        "description": "Create a calculation and then delete it by ID. Verifies 204 response with no body.",
        "request_data": {
            "path": {
                "calculation_id": "$setup_id"
            },

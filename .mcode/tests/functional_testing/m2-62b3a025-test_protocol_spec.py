...
Generated at: 2026-02-24T01:07:19.653708+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    },
    {
        ...
        "endpoint": "/auth/register",
        "method": "POST",
        "description": "Attempt to register a user with a username that already exists, expect 400 with 'Username already taken'",
        "setup": {
            "endpoint": "/auth/register",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/auth/token",
        "method": "POST",
        "description": "Obtain a JWT access token with valid credentials via form-encoded request, expect 200 with access_token and token_type",
        "setup": {
            "endpoint": "/auth/register",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/auth/token",
        "method": "POST",
        "description": "Attempt to obtain a token with a valid username but incorrect password, expect 401",
        "setup": {
            "endpoint": "/auth/register",
            "method": "POST",
            "body": {
                "username": "testuser_badpw",
                "password": "${AUTH_PASSWORD}"
            },
            "extract_id_from": "id"
        },
    ...
    },
    {
        ...
        "endpoint": "/auth/token",
        "method": "POST",
        "description": "Attempt to obtain a token for a user that does not exist, expect 401",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},

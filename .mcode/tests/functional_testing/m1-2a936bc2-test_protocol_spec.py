...
Generated at: 2026-03-03T19:15:12.197470+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/health",
        "method": "GET",
        "description": "Verify the health check endpoint returns 200 with status ok and version 0.1.0",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    {
        "name": "health_check_response_fields",
        "category": "HAPPY_PATH",
        "endpoint": "/health",
        "method": "GET",
        "description": "Verify health check response contains both required fields: status and version",
        "request_data": {
            "path": {},
            "query": {},
            "body": null

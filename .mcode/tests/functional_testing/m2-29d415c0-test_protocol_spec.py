...
Generated at: 2026-02-24T14:36:22.550287+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    {
        "name": "register_testuser",
        "category": "SETUP",
        "endpoint": "/auth/register",
        "method": "POST",
        "description": "Register testuser account needed by login and duplicate-registration tests",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/auth/token",
        "method": "POST",
        "description": "Login with valid credentials and get JWT token (propagates auth to session)",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/divide",
        "method": "POST",
        "description": "Attempt to divide by zero, expect 400 with 'Cannot divide by zero' error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Create an add calculation record and verify 201 response with computed result",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Attempt to create a calculation without authentication, expect 401",
        "skip_auth": true,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/calculations/{calculation_id}",
        "method": "GET",
        "description": "Attempt to get a calculation without authentication, expect 401",
        "skip_auth": true,
        "request_data": {
            "path": {
                "calculation_id": 1
    ...
    },
    {
        ...
        "endpoint": "/calculations/{calculation_id}",
        "method": "DELETE",
        "description": "Attempt to delete a calculation without authentication, expect 401",
        "skip_auth": true,
        "request_data": {
            "path": {
                "calculation_id": 1

...
Generated at: 2026-02-19T08:56:05.008232+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "method": "POST",
        "description": "Register a new user with valid username and password, expect 201 with user info returned",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/auth/token",
        "method": "POST",
        "description": "Login with incorrect password, expect 401 with 'Incorrect username or password'",
        "setup": {
            "endpoint": "/auth/register",
            "method": "POST",
            "body": {
    ...
    {
        "name": "protected_endpoint_no_token",
        "category": "INVALID_INPUT",
        "endpoint": "/add",
        "method": "POST",
    ...
    {
        "name": "protected_endpoint_invalid_token",
        "category": "INVALID_INPUT",
        "endpoint": "/add",
        "method": "POST",
        ...
        "request_data": {
            ...
            "headers": {
                "Authorization": "Bearer invalidtokenstring"
            }
        },
        "expected_status": 401,
        "setup": null,
    ...
    {
        "name": "protected_endpoint_with_valid_token",
        "category": "HAPPY_PATH",
        "endpoint": "/add",
        "method": "POST",
        "description": "Access a protected calculator endpoint with a valid Bearer token, expect 200 with correct result",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/health",
        "method": "GET",
        "description": "Health check endpoint returns 200 with status ok and version",
        "request_data": {
            "path": {},
            "query": {},
            "body": null

...
Generated at: 2026-02-18T22:11:13.849028+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    },
    {
        ...
        "endpoint": "/auth/token",
        "method": "POST",
        "description": "Login with the test user to obtain a JWT access token",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Create a calculation record with a valid operation (mul)",
        "request_data": {
            "path": {},
            "query": {},
            "body": {

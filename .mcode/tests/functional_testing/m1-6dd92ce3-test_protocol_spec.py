...
Generated at: 2026-02-24T14:15:54.209118+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    },
    {
        ...
        "endpoint": "/auth/token",
        "method": "POST",
        "description": "Attempt login with an incorrect password, expect 401 unauthorized",
        "setup": {
            "endpoint": "/auth/register",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/auth/token",
        "method": "POST",
        "description": "Attempt login with a username that does not exist, expect 401 unauthorized",
        "request_data": {
            "path": {},
            "query": {},
            "body": {

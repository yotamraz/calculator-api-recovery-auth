...
Generated at: 2026-02-19T09:01:15.385800+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/health",
        "method": "GET",
        "description": "Verify health endpoint returns status ok and version",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Register a new user successfully and verify response contains id, username, and created_at",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
                "username": "testuser_register_fresh",
    ...
    },
    {
        ...
        "endpoint": "/auth/register",
        "method": "POST",
        "description": "Attempt to register with an already existing username and expect 400 error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/auth/register",
        "method": "POST",
        "description": "Attempt to register without providing a password field and expect 422 validation error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/auth/token",
        "method": "POST",
        "description": "Attempt to login with wrong password and expect 401 unauthorized",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/auth/token",
        "method": "POST",
        "description": "Attempt to login with a username that does not exist and expect 401",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/add",
        "method": "POST",
        "description": "Add two numbers with valid authentication and verify correct result",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/add",
        "method": "POST",
        "description": "Attempt to add without providing authentication token and expect 401",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/add",
        "method": "POST",
        "description": "Attempt to add with missing operand b and expect 422 validation error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/subtract",
        "method": "POST",
        "description": "Subtract two numbers with valid authentication and verify correct result",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/subtract",
        "method": "POST",
        "description": "Attempt to subtract without authentication token and expect 401",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/multiply",
        "method": "POST",
        "description": "Multiply two numbers with valid authentication and verify correct result",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/multiply",
        "method": "POST",
        "description": "Attempt to multiply without authentication token and expect 401",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/divide",
        "method": "POST",
        "description": "Divide two numbers with valid authentication and verify correct result",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/divide",
        "method": "POST",
        "description": "Attempt to divide by zero and expect 400 error with 'Cannot divide by zero' message",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/divide",
        "method": "POST",
        "description": "Attempt to divide without authentication token and expect 401",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Create a new calculation record with valid operation and verify it returns 201 with id",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Attempt to create a calculation with an unknown operation and expect 400 error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Attempt to create a division calculation with zero divisor and expect 400 error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "GET",
        "description": "List all calculations with valid authentication and expect 200 with array response",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "method": "GET",
        "description": "Create a calculation, then retrieve it by ID and verify the correct record is returned",
        "request_data": {
            "path": {
    ...
    },
    {
        ...
        "endpoint": "/calculations/{calculation_id}",
        "method": "GET",
        "description": "Attempt to retrieve a calculation with a non-existent ID and expect 404",
        "request_data": {
            "path": {
    ...
    {
        "name": "get_calculation_no_auth",
        "category": "INVALID_INPUT",
        "endpoint": "/calculations/{calculation_id}",
        "method": "GET",
        "description": "Attempt to retrieve a calculation without authentication and expect 401",
        "request_data": {
            "path": {
                "calculation_id": 1
            },
    ...
    },
    {
        ...
        "endpoint": "/calculations/{calculation_id}",
        "method": "DELETE",
        "description": "Create a calculation, then delete it by ID and expect 204 no content",
        "request_data": {
            "path": {
                "calculation_id": "$setup_id"
            },
    ...
    },
    {
        ...
        "endpoint": "/calculations/{calculation_id}",
        "method": "DELETE",
        "description": "Attempt to delete a calculation with a non-existent ID and expect 404",
        "request_data": {
            "path": {
                "calculation_id": 999999
            },
    ...
    {
        "name": "delete_calculation_no_auth",
        "category": "INVALID_INPUT",
        "endpoint": "/calculations/{calculation_id}",
        "method": "DELETE",
        "description": "Attempt to delete a calculation without authentication and expect 401",
        "request_data": {
            "path": {
                "calculation_id": 1
            },
...
def build_url(endpoint: str, path_params: dict[str, Any], query_params: dict[str, Any]) -> str:
    """Build the full request URL with path and query parameters."""
    for name, value in path_params.items():
        endpoint = endpoint.replace(f"{{{name}}}", str(value))
    if query_params:
        endpoint = f"{endpoint}?{'&'.join(f'{k}={v}' for k, v in query_params.items())}"
...
def make_request(
    ...
    """
    url = build_url(endpoint, path_params, query_params)

...
Generated at: 2026-02-17T21:29:18.284415+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/health",
        "method": "GET",
        "description": "Verify health endpoint returns status ok and version 0.1.0",
        "skip_auth": true,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "actual_response": {
            "id": 1,
            "username": "testuser_reg_happy",
            "created_at": "2026-02-17T20:55:24.301745"
        }
    },
    {
    ...
    },
    {
        ...
        "endpoint": "/auth/register",
        "method": "POST",
        "description": "Attempt to register a user without providing a password field",
        "skip_auth": true,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/auth/token",
        "method": "POST",
        "description": "Login with valid credentials using OAuth2 password form and receive a token. This test populates the auth session for subsequent tests.",
        "setup": {
            "endpoint": "/auth/register",
            "method": "POST",
            "body": {
                "username": "testuser_login_happy",
                "password": "${TEST_PASSWORD}"
            }
        },
        "request_data": {
        ...
        "cleanup": null,
        "actual_response": {
            "access_token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJ0ZXN0dXNlcl9sb2dpbl9oYXBweSIsImV4cCI6MTc3MTM2MzUyNH0.r8Alf4C8d45TDEnGFw43yOdnE7P9UfKpTNfoDeuMJ7E",
            "token_type": "bearer"
        }
    },
    {
        ...
        "endpoint": "/auth/token",
        "method": "POST",
        "description": "Attempt to login with wrong password and expect 401",
        "skip_auth": true,
        "setup": {
            "endpoint": "/auth/register",
            "method": "POST",
    ...
    },
    {
        ...
        "endpoint": "/auth/token",
        "method": "POST",
        "description": "Attempt to login with a username that does not exist",
        "skip_auth": true,
        "request_data": {
            "path": {},
            "query": {},
    ...
    {
        "name": "add_unauthenticated",
        "category": "INVALID_INPUT",
        "endpoint": "/add",
        "method": "POST",
        "description": "Attempt to add numbers without providing an auth token, expect 401",
        "skip_auth": true,
        "request_data": {
            "path": {},
            "query": {},
    ...
    {
        "name": "subtract_unauthenticated",
        "category": "INVALID_INPUT",
        "endpoint": "/subtract",
        "method": "POST",
        "description": "Attempt to subtract without auth token, expect 401",
        "skip_auth": true,
        "request_data": {
            "path": {},
            "query": {},
    ...
    {
        "name": "multiply_unauthenticated",
        "category": "INVALID_INPUT",
        "endpoint": "/multiply",
        "method": "POST",
        "description": "Attempt to multiply without auth token, expect 401",
        "skip_auth": true,
        "request_data": {
            "path": {},
            "query": {},
    ...
    {
        "name": "divide_unauthenticated",
        "category": "INVALID_INPUT",
        "endpoint": "/divide",
        "method": "POST",
        "description": "Attempt to divide without auth token, expect 401",
        "skip_auth": true,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "actual_response": {
            ...
            "result": 40.0,
            "id": 1,
            "created_at": "2026-02-17T20:55:25.157714"
        }
    },
    {
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Attempt to create a div calculation with b=0, expect 400",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    {
        "name": "create_calculation_unauthenticated",
        "category": "INVALID_INPUT",
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Attempt to create a calculation without auth token, expect 401",
        "skip_auth": true,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "GET",
        "description": "List all stored calculations with valid authentication",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    {
        "name": "list_calculations_unauthenticated",
        "category": "INVALID_INPUT",
        "endpoint": "/calculations",
        "method": "GET",
        "description": "Attempt to list calculations without auth token, expect 401",
        "skip_auth": true,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "actual_response": {
            ...
            "result": 27.0,
            "id": 2,
            "created_at": "2026-02-17T20:55:25.166963"
        }
    },
    {
    ...
    if isinstance(expected, dict):
        for key, exp_val in expected.items():
            ...
            if key.lower() in {f.lower() for f in DYNAMIC_FIELDS}:
                if not is_same_type(actual[key], exp_val):
                    violations.append(

...
Generated at: 2026-02-18T10:32:43.670417+00:00
...
TEST_CASES = json.loads(r'''[
    {
        ...
        "endpoint": "/health",
        "method": "GET",
        "description": "Verify the health check endpoint returns status ok and version 0.1.0",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Register a new user and verify 201 response with user details",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/add",
        "method": "POST",
        "description": "Attempt addition without authentication token, expect 401",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/subtract",
        "method": "POST",
        "description": "Attempt subtraction without authentication token, expect 401",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/multiply",
        "method": "POST",
        "description": "Attempt multiplication without authentication token, expect 401",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/divide",
        "method": "POST",
        "description": "Attempt division without authentication token, expect 401",
        "request_data": {
            "path": {},
            "query": {},
            "body": {

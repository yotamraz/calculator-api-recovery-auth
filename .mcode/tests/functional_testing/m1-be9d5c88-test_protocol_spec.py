...
Generated at: 2026-02-24T01:04:35.829103+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "expected_status": 200,
        "description": "Verify GET /health returns 200 with status ok and version 0.1.0",
        "setup": null,
        "cleanup": null
    },
    {
        "name": "health_check_response_has_status_field",
        "category": "HAPPY_PATH",
        "endpoint": "/health",
        "method": "GET",
        "request_data": {
        ...
        "expected_status": 200,
        "description": "Verify the health response body contains the required status field with value ok",
        "setup": null,
        "cleanup": null
    },
    {
        "name": "health_check_response_has_version_field",
        "category": "HAPPY_PATH",
        "endpoint": "/health",
        "method": "GET",
        "request_data": {
        ...
        "expected_status": 200,
        "description": "Verify the health response body contains the required version field with value 0.1.0",
        "setup": null,
        "cleanup": null
    }
]''')

...
Generated at: 2026-02-24T14:51:35.860368+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/health",
        "method": "GET",
        "description": "Verify the health endpoint returns ok status and correct version",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "endpoint": "/auth/token",
        "method": "POST",
        "description": "Login with valid credentials using form-encoded data, expect 200 with JWT token",
        "setup": {
            "endpoint": "/auth/register",
            "method": "POST",
            "body": {

...
Generated at: 2026-03-03T20:04:36.361951+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "actual_response": {
            "id": 1,
            "username": "testuser_reg1",
            "created_at": "2026-03-03T19:50:46.789422"
        }
    },
    {
    ...
    },
    {
        ...
        "endpoint": "/auth/register",
        "method": "POST",
        "description": "Attempt to register without providing the password field, expect 422 validation error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/auth/register",
        "method": "POST",
        "description": "Attempt to register without providing the username field, expect 422 validation error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {

...
Generated at: 2026-02-18T08:32:04.726791+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    },
    {
        ...
        "endpoint": "/auth/token",
        "method": "POST",
        "description": "Attempt to login with an incorrect password",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
                "username": "testuser_loginbad",
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Create a calculation record with a valid operation and verify the response",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Attempt to create a calculation with an unknown operation name",
        "request_data": {
            "path": {},
            "query": {},
            "body": {

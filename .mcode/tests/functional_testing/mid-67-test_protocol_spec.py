...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Register a new user and verify response contains id, username, and created_at",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/auth/register",
        "method": "POST",
        "description": "Attempt to register without a password field and expect 422 validation error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
                "username": "testuser_no_pw_v9"
            }
        },
        "expected_status": 422,
        "setup": null,
    ...
    },
    {
        ...
        "endpoint": "/auth/token",
        "method": "POST",
        "description": "Login endpoint receives JSON instead of required form-encoded data, expects 422 validation error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
                "username": "testuser_login_hp_v9",
                "password": "${TEST_PASSWORD}"
            }
        },
        "expected_status": 422,
    ...
    },
    {
        ...
        "request_data": {
            ...
            "query": {},
            "body": {
                "username": "testuser_login_bad_v9",
    ...
    },
    {
        ...
        "request_data": {
            ...
            "query": {},
            "body": {
                "username": "nonexistent_user_xyz_v9",
    ...
    },
    {
        ...
        "endpoint": "/add",
        "method": "POST",
        "description": "Add two numbers with valid authentication and verify result",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/add",
        "method": "POST",
        "description": "Attempt add operation without authentication token and expect 401",
        "skip_auth": true,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/divide",
        "method": "POST",
        "description": "Attempt division by zero and expect 400 error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/divide",
        "method": "POST",
        "description": "Attempt divide without authentication and expect 401",
        "skip_auth": true,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Create a new calculation record with valid operation and operands",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Attempt to create a calculation with an unknown operation and expect 400",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Attempt to create a division calculation with b=0 and expect 400",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations/{calculation_id}",
        "method": "GET",
        "description": "Attempt to retrieve a non-existent calculation and expect 404",
        "request_data": {
            "path": {
    ...
    },
    {
        ...
        "endpoint": "/calculations/{calculation_id}",
        "method": "DELETE",
        "description": "Create a calculation, then delete it and expect 204",
        "setup": {
            "endpoint": "/calculations",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations/{calculation_id}",
        "method": "DELETE",
        "description": "Attempt to delete a non-existent calculation and expect 404",
        "request_data": {
            "path": {
                "calculation_id": 999999
            },

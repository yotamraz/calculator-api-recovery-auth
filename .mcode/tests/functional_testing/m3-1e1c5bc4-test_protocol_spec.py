...
Generated at: 2026-03-01T10:58:37.820810+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "actual_response": {
            "id": 6,
            "username": "testuser",
            "created_at": "2026-03-01T09:40:08.527449"
        }
    },
    {
    ...
    },
    {
        ...
        "endpoint": "/add",
        "method": "POST",
        "description": "Add two positive numbers and verify result",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/subtract",
        "method": "POST",
        "description": "Subtract b from a and verify result",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/subtract",
        "method": "POST",
        "description": "Subtract larger number from smaller, yielding negative result",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/multiply",
        "method": "POST",
        "description": "Multiply two numbers and verify result",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/multiply",
        "method": "POST",
        "description": "Multiply a number by zero, expect result of 0",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/divide",
        "method": "POST",
        "description": "Divide a by b and verify result",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Create a calculation with add operation, expect 201 with full record",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
        ...
        "actual_response": {
            ...
            "result": 40.0,
            "id": 2,
            "created_at": "2026-03-01T09:40:08.721898"
        }
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Create a calculation with div operation, expect 201",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
        ...
        "actual_response": {
            ...
            "result": 25.0,
            "id": 3,
            "created_at": "2026-03-01T09:40:08.724200"
        }
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Create a calculation with an unknown operation, expect 400 with error message",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Create a calculation with div and b=0, expect 400 Cannot divide by zero",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "GET",
        "description": "List all calculations, expect 200 with array",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
        ...
        "actual_response": [
            ...
            },
            {
                ...
                "result": 40.0,
                "id": 1,
                "created_at": "2026-02-28T23:06:23.537833"
            }
        ]
    },
    {
    ...
    },
    {
        ...
        "method": "GET",
        "description": "Create a calculation, then retrieve it by ID, expect 200 with full record",
        "setup": {
            "endpoint": "/calculations",
            "method": "POST",
            "body": {
        ...
        "actual_response": {
            ...
            "result": 56.0,
            "id": 4,
            "created_at": "2026-03-01T09:40:08.731137"
        }
    },
    {
        ...
        "endpoint": "/calculations/{calculation_id}",
        "method": "GET",
        "description": "Attempt to get a non-existent calculation, expect 404 'Calculation not found'",
        "request_data": {
            "path": {
    ...
    },
    {
        ...
        "endpoint": "/calculations/{calculation_id}",
        "method": "DELETE",
        "description": "Create a calculation and then delete it, expect 204 no content",
        "setup": {
            "endpoint": "/calculations",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations/{calculation_id}",
        "method": "DELETE",
        "description": "Attempt to delete a non-existent calculation, expect 404 'Calculation not found'",
        "request_data": {
            "path": {
                "calculation_id": 999999
            },

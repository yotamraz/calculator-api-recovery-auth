...
Generated at: 2026-02-17T18:00:17.593608+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    },
    {
        ...
        "request_data": {
            ...
            "query": {},
            "body": {
                "username": "testuser_login_hp_v10",
                "password": "${TEST_USER_PASSWORD}",
                "grant_type": "password"
            }
        },
    ...
    },
    {
        ...
        "request_data": {
            ...
            "query": {},
            "body": {
                "username": "testuser_login_bad_v10",
    ...
    },
    {
        ...
        "endpoint": "/auth/token",
        "method": "POST",
        "description": "Login with a nonexistent username, expect 422 (runner sends JSON not form data)",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
                "username": "nonexistent_user_xyz_v10",

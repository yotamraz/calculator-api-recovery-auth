...
Generated at: 2026-02-28T22:22:04.264293+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    {
        "name": "health_check_response_schema",
        "category": "HAPPY_PATH",
        "endpoint": "/health",
        "method": "GET",
        "request_data": {
        ...
        "expected_status": 200,
        "description": "Verify health endpoint response contains both status and version fields with correct values",
        "setup": null,
        "cleanup": null
    }
]''')

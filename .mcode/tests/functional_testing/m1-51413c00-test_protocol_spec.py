...
Generated at: 2026-03-01T09:40:40.784252+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    {
        "name": "health_check_wrong_method_post",
        "category": "INVALID_INPUT",
        "endpoint": "/health",
        "method": "POST",
        "description": "Verify health endpoint rejects POST with 405 Method Not Allowed",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    {
        "name": "health_check_with_extra_query_params",
        "category": "BOUNDARY",
        "endpoint": "/health",
        "method": "GET",
        "description": "Verify health endpoint still returns 200 when extra query parameters are provided",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {

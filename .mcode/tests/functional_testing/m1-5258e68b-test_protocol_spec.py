...
Generated at: 2026-02-24T16:23:49.749430+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/health",
        "method": "GET",
        "description": "Verify health endpoint returns 200 with status ok and version string",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    {
        "name": "health_check_no_auth_required",
        "category": "HAPPY_PATH",
        "endpoint": "/health",
        "method": "GET",
        "description": "Verify health endpoint is publicly accessible without any authentication header",
        "request_data": {
            "path": {},
            "query": {},
            "body": null,
    ...
    {
        "name": "health_check_method_not_allowed",
        "category": "INVALID_INPUT",
        "endpoint": "/health",
        "method": "POST",
        "description": "Verify health endpoint rejects POST requests with 405 Method Not Allowed",
        "request_data": {
            "path": {},
            "query": {},
            "body": {}

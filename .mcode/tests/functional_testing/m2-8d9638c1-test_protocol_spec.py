...
Generated at: 2026-02-24T16:16:34.313868+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    },
    {
        ...
        "endpoint": "/auth/register",
        "method": "POST",
        "description": "Attempt to register without providing a username field, expect 422 validation error",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/auth/token",
        "method": "POST",
        "description": "Register a user then obtain a JWT token with valid credentials, expect 200 with access_token",
        "setup": {
            "endpoint": "/auth/register",
            "method": "POST",
            "body": {
                "username": "testuser_tok1",
                "password": "${AUTH_PASSWORD}"
            }
        },
        "request_data": {
    ...
    },
    {
        ...
        "endpoint": "/auth/token",
        "method": "POST",
        "description": "Attempt login without providing username or password, expect 422 validation error",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},

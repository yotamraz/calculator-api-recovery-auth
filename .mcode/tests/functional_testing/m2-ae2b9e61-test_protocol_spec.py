...
Generated at: 2026-02-28T22:50:23.912576+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    },
    {
        ...
        "endpoint": "/auth/register",
        "method": "POST",
        "description": "Attempt to register without a username field, expect 400 or 422 validation error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/auth/register",
        "method": "POST",
        "description": "Attempt to register without a password field, expect 400 or 422 validation error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/auth/token",
        "method": "POST",
        "description": "Login with valid credentials using form-encoded data, expect 200 with access_token and token_type",
        "setup": {
            "endpoint": "/auth/register",
            "method": "POST",
            "body": {
        ...
        "request_data": {
            ...
            "body": "username=login_user&password=${AUTH_PASSWORD}"
        },
        "expected_status": 200,
        "cleanup": null
    },
    {
        ...
        "endpoint": "/auth/token",
        "method": "POST",
        "description": "Attempt login with wrong password, expect 401 with 'Incorrect username or password'",
        "setup": {
            "endpoint": "/auth/register",
            "method": "POST",
            "body": {
        ...
        "request_data": {
            ...
            "body": "username=wrongpw_user&password=completely_wrong_password"
        },
        "expected_status": 401,
        "cleanup": null
    },
    {
        ...
        "request_data": {
            ...
            "body": "username=nonexistent_user_xyz&password=any_password"
        },
        "expected_status": 401,
        "cleanup": null
    }

...
Generated at: 2026-02-17T07:51:52.173107+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/health",
        "method": "GET",
        "description": "Verify health endpoint returns 200 with status ok and version",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    {
        "name": "add_missing_required_field",
        "category": "MISSING_REQUIRED",
        "endpoint": "/add",
        "method": "POST",
        "description": "Attempt to add with missing field b, expect validation error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/add",
        "method": "POST",
        "description": "Attempt to add with string instead of number, expect validation error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    {
        "name": "subtract_missing_required_field",
        "category": "MISSING_REQUIRED",
        "endpoint": "/subtract",
        "method": "POST",
        "description": "Attempt to subtract with missing field a, expect validation error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    {
        "name": "multiply_boundary_zero",
        "category": "BOUNDARY",
        "endpoint": "/multiply",
        "method": "POST",
        "description": "Multiply by zero and verify result is zero",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    {
        "name": "divide_missing_required_field",
        "category": "MISSING_REQUIRED",
        "endpoint": "/divide",
        "method": "POST",
        "description": "Attempt to divide with missing fields, expect validation error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {}
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Create a new stored calculation with add operation and verify 201 response",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Attempt to create a stored division by zero calculation, expect 400",
        "request_data": {
            "path": {},
            "query": {},
            "body": {

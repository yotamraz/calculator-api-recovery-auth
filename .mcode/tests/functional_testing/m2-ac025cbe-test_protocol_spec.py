...
Generated at: 2026-02-28T19:32:11.462675+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    },
    {
        ...
        "endpoint": "/auth/token",
        "method": "POST",
        "description": "Authenticate with valid credentials using form-encoded data, expect 200 with access_token and token_type",
        "setup": {
            "endpoint": "/auth/register",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "request_data": {
            ...
            "body": "username=testuser_badpw&password=wrongpassword"
        },
        "expected_status": 401,
        "cleanup": null
    },

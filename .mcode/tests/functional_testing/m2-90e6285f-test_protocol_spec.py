...
Generated at: 2026-03-01T10:07:06.301289+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "actual_response": {
            "id": 1,
            "username": "testuser_reg1",
            "created_at": "2026-03-01T09:44:24.581814"
        }
    },
    {
        ...
        "endpoint": "/auth/register",
        "method": "POST",
        "description": "Attempt to register with an already-taken username, expect 400 with 'Username already taken'",
        "setup": {
            "endpoint": "/auth/register",
            "method": "POST",
            "body": {
    ...
    {
        "name": "register_missing_username",
        "category": "MISSING_REQUIRED",
        "endpoint": "/auth/register",
        "method": "POST",
        "description": "Attempt to register without a username field, expect 422 validation error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/auth/register",
        "method": "POST",
        "description": "Attempt to register without a password field, expect 422 validation error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/auth/token",
        "method": "POST",
        "description": "Login with valid credentials (form-encoded), expect 200 with access_token and token_type",
        "setup": {
            "endpoint": "/auth/register",
            "method": "POST",
            "body": {
    ...
    {
        "name": "token_invalid_password",
        "category": "INVALID_INPUT",
        "endpoint": "/auth/token",
        "method": "POST",
        "description": "Login with correct username but wrong password, expect 401 with 'Incorrect username or password'",
        "setup": {
            "endpoint": "/auth/register",
            "method": "POST",
            "body": {
    ...
    {
        "name": "token_nonexistent_user",
        "category": "INVALID_INPUT",
        "endpoint": "/auth/token",
        "method": "POST",
        "description": "Login with a username that does not exist, expect 401 with 'Incorrect username or password'",
        "request_data": {
            "path": {},
            "query": {},
            "content_type": "form",
    ...
    {
        "name": "token_missing_fields",
        "category": "MISSING_REQUIRED",
        "endpoint": "/auth/token",
        "method": "POST",
        "description": "Submit token request with empty form body, expect 422 validation error",
        "request_data": {
            "path": {},
            "query": {},
            "content_type": "form",

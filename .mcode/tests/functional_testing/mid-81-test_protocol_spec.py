...
Generated at: 2026-02-18T22:00:32.984175+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/health",
        "method": "GET",
        "description": "Verify the health endpoint returns 200 with status ok and version",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Register a new user with valid username and password, expect 201 with user response",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
                "username": "testuser_reg_hp_v4_unique",
    ...
    },
    {
        ...
        "endpoint": "/auth/register",
        "method": "POST",
        "description": "Register a user with a username that already exists, expect 400 with 'Username already taken'",
        "setup": {
            "endpoint": "/auth/register",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/auth/register",
        "method": "POST",
        "description": "Register a user without providing a password field, expect 422 validation error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/auth/token",
        "method": "POST",
        "description": "Login with valid credentials using OAuth2 password form, expect 200 with access_token and token_type",
        "setup": {
            "endpoint": "/auth/register",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/auth/token",
        "method": "POST",
        "description": "Login with a valid username but wrong password, expect 401",
        "setup": {
            "endpoint": "/auth/register",
            "method": "POST",
            "body": {
                "username": "testuser_login_badpw",
                "password": "${AUTH_PASSWORD}"
            },
            "required": false
        },
    ...
    },
    {
        ...
        "endpoint": "/add",
        "method": "POST",
        "description": "Add two numbers with a valid auth token, expect 200 with correct result",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/add",
        "method": "POST",
        "description": "Attempt to add without providing an authentication token, expect 401",
        "skip_auth": true,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/subtract",
        "method": "POST",
        "description": "Subtract two numbers with a valid auth token, expect 200 with correct result",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/multiply",
        "method": "POST",
        "description": "Multiply two numbers with a valid auth token, expect 200 with correct result",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/divide",
        "method": "POST",
        "description": "Divide two numbers with a valid auth token, expect 200 with correct result",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/divide",
        "method": "POST",
        "description": "Attempt division by zero with valid auth, expect 400 error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Create a new calculation record with valid auth, expect 201 with calculation response including id",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Create a calculation with an unknown operation, expect 400",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "GET",
        "description": "List all calculations with valid auth, expect 200 with array response",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "method": "GET",
        "description": "Create a calculation, then retrieve it by ID, expect 200",
        "setup": {
            "endpoint": "/calculations",
            "method": "POST",
            "body": {

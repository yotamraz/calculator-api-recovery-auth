...
Generated at: 2026-02-17T23:24:30.155692+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    },
    {
        ...
        "actual_response": {
            "id": 10,
            "username": "newuser_hp_x7k2m9p4q",
            "created_at": "2026-02-17T22:27:08.713935"
        }
    },
    {
    ...
    },
    {
        ...
        "endpoint": "/auth/register",
        "method": "POST",
        "description": "Register without password field, expect 422 validation error",
        "skip_auth": true,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/auth/token",
        "method": "POST",
        "description": "Login with valid credentials via OAuth2 form and receive a JWT token. This test sets up auth for subsequent tests.",
        "skip_auth": true,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "actual_response": {
            ...
            "result": 42.0,
            "id": 3,
            "created_at": "2026-02-17T22:27:09.063962"
        }
    },
    {
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Create a calculation with div by zero, expect 400",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "actual_response": [
            ...
            },
            {
                ...
                "result": 42.0,
                "id": 2,
                "created_at": "2026-02-17T22:25:14.135179"
            },
            {
                "operation": "add",
                "a": 15.0,
    ...
    },
    {
        ...
        "actual_response": {
            ...
            "result": 3.0,
            "id": 4,
            "created_at": "2026-02-17T22:27:09.070868"
        }
    },
    {

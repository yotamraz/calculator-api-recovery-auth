...
Generated at: 2026-02-28T22:23:29.345868+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    },
    {
        ...
        "endpoint": "/auth/token",
        "method": "POST",
        "description": "Authenticate with valid credentials (form-encoded), expect 200 with access_token and token_type",
        "setup": {
            "endpoint": "/auth/register",
            "method": "POST",
            "body": {
    ...
    {
        "name": "token_wrong_password",
        "category": "INVALID_INPUT",
        "endpoint": "/auth/token",
        "method": "POST",
        "description": "Authenticate with wrong password, expect 401 with 'Incorrect username or password'",
        "setup": {
            "endpoint": "/auth/register",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/auth/token",
        "method": "POST",
        "description": "Authenticate with a username that does not exist, expect 401",
        "request_data": {
            "path": {},
            "query": {},
            "headers": {

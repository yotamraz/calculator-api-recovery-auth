...
Generated at: 2026-02-28T20:10:17.323098+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/auth/token",
        "method": "POST",
        "description": "Register user (if needed) then obtain JWT access token for all authenticated tests",
        "setup": {
    ...
    },
    {
        ...
        "endpoint": "/subtract",
        "method": "POST",
        "description": "Attempt to subtract without authentication token, expect 401",
        "skip_auth": true,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/multiply",
        "method": "POST",
        "description": "Multiply by zero and verify the result is zero",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/multiply",
        "method": "POST",
        "description": "Attempt to multiply without authentication token, expect 401",
        "skip_auth": true,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Create a calculation with 'add' operation and verify 201 response with full record",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Create a calculation with 'div' operation and verify 201 response",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Create a calculation with div operation and b=0, expect 400 with division by zero error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "GET",
        "description": "List all calculations, expect 200 with an array response",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    {
        "name": "get_calculation_unauthenticated",
        "category": "AUTH",
        "endpoint": "/calculations/{calculation_id}",
        "method": "GET",
        "description": "Attempt to get a calculation without auth, expect 401",
        "skip_auth": true,
        "request_data": {
            "path": {
                "calculation_id": 1
    ...
    {
        "name": "delete_calculation_unauthenticated",
        "category": "AUTH",
        "endpoint": "/calculations/{calculation_id}",
        "method": "DELETE",
        "description": "Attempt to delete a calculation without auth, expect 401",
        "skip_auth": true,
        "request_data": {
            "path": {
                "calculation_id": 1

...
Generated at: 2026-02-24T17:16:08.035167+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    },
    {
        ...
        "endpoint": "/add",
        "method": "POST",
        "description": "Add two positive numbers and verify the correct result",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/add",
        "method": "POST",
        "description": "Add two negative numbers and verify the correct result",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/subtract",
        "method": "POST",
        "description": "Subtract two numbers and verify the correct result",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/multiply",
        "method": "POST",
        "description": "Multiply two numbers and verify the correct result",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/divide",
        "method": "POST",
        "description": "Divide two numbers and verify the correct result",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations/{calculation_id}",
        "method": "GET",
        "description": "Attempt to get a calculation by ID without authentication, expect 401",
        "request_data": {
            "path": {
                "calculation_id": 1
            },

...
Generated at: 2026-02-21T12:03:47.849511+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Register a new user with valid username and password, expect 201 with user info",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/auth/register",
        "method": "POST",
        "description": "Attempt to register a user with an already-taken username, expect 400",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/auth/register",
        "method": "POST",
        "description": "Attempt to register a user without providing a password field, expect 422 validation error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    {
        "name": "auth_token_happy_path",
        "category": "AUTH",
        "endpoint": "/auth/token",
        "method": "POST",
        "description": "Obtain a JWT token with valid credentials using form-encoded body",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
                "username": "testuser_token1",
                "password": "${TEST_PASSWORD}"
            },
    ...
    {
        "name": "auth_token_invalid_credentials",
        "category": "INVALID_INPUT",
        "endpoint": "/auth/token",
        "method": "POST",
        "description": "Attempt to obtain a JWT with invalid password, expect 401",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
                "username": "testuser_token2",
    ...
    {
        "name": "auth_token_nonexistent_user",
        "category": "INVALID_INPUT",
        "endpoint": "/auth/token",
        "method": "POST",
        "description": "Attempt to obtain a JWT with a username that does not exist, expect 401",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/add",
        "method": "POST",
        "description": "Add two numbers with a valid JWT token, expect result in response",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/add",
        "method": "POST",
        "description": "Attempt to add two numbers without a JWT token, expect 401",
        "skip_auth": true,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/subtract",
        "method": "POST",
        "description": "Subtract two numbers with a valid JWT token, expect correct result",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/subtract",
        "method": "POST",
        "description": "Attempt to subtract without a JWT token, expect 401",
        "skip_auth": true,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/multiply",
        "method": "POST",
        "description": "Multiply two numbers with a valid JWT token, expect correct result",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/multiply",
        "method": "POST",
        "description": "Attempt to multiply without a JWT token, expect 401",
        "skip_auth": true,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/divide",
        "method": "POST",
        "description": "Divide two numbers with a valid JWT token, expect correct result",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/divide",
        "method": "POST",
        "description": "Attempt to divide without a JWT token, expect 401",
        "skip_auth": true,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Create and persist a calculation record with valid operation, expect 201",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Attempt to create a div calculation with b=0, expect 400 with divide by zero error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Attempt to create a calculation without a JWT token, expect 401",
        "skip_auth": true,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "GET",
        "description": "List all stored calculations with valid JWT, expect 200 with array",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "GET",
        "description": "Attempt to list calculations without a JWT token, expect 401",
        "skip_auth": true,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "method": "GET",
        "description": "Create a calculation, then retrieve it by ID, expect 200 with calculation data",
        "request_data": {
            "path": {

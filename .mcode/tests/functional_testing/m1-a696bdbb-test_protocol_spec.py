...
Generated at: 2026-02-28T19:32:03.368842+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "expected_status": 200,
        "description": "Verify the health endpoint returns 200 with status ok and version 0.1.0",
        "setup": null,
        "cleanup": null
    },
    {
        ...
        "expected_status": 405,
        "description": "Verify the health endpoint rejects POST requests with 405 Method Not Allowed",
        "setup": null,
        "cleanup": null
    }
]''')

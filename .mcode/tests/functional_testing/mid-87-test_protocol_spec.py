...
Generated at: 2026-02-19T10:13:38.657692+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Register a new user with valid username and password, expect 201 with user details returned",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
                "username": "fresh_register_user_hp",
    ...
    },
    {
        ...
        "endpoint": "/auth/register",
        "method": "POST",
        "description": "Attempt to register a user with an already taken username, expect 400 with 'Username already taken' message",
        "setup": {
            "endpoint": "/auth/register",
            "method": "POST",
            "body": {
    ...
    {
        "name": "register_user_missing_username",
        "category": "MISSING_REQUIRED",
        "endpoint": "/auth/register",
        "method": "POST",
        "description": "Attempt to register a user without providing a username field, expect 422 validation error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/auth/token",
        "method": "POST",
        "description": "Authenticate and obtain a JWT token for subsequent tests",
        "setup": {
            "endpoint": "/auth/register",
            "method": "POST",
            "body": {
                "username": "auth_cascade_user",
                "password": "SecureTestPass123!"
            },
            "extract_id_from": "id"
        },
    ...
    },
    {
        ...
        "endpoint": "/auth/token",
        "method": "POST",
        "description": "Login with valid credentials using OAuth2 password form, expect 200 with access_token and token_type='bearer'",
        "setup": {
            "endpoint": "/auth/register",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/auth/token",
        "method": "POST",
        "description": "Login with a valid username but wrong password, expect 401 with 'Incorrect username or password'",
        "setup": {
            "endpoint": "/auth/register",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/auth/token",
        "method": "POST",
        "description": "Login with a username that does not exist in the database, expect 401",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    {
        "name": "login_missing_username_field",
        "category": "MISSING_REQUIRED",
        "endpoint": "/auth/token",
        "method": "POST",
        "description": "Submit token request without username field, expect 422 validation error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {

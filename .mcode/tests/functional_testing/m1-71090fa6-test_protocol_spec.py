...
Generated at: 2026-02-19T21:41:28.426681+00:00
...
TEST_CASES = json.loads(r'''[
    ...
    },
    {
        ...
        "endpoint": "/auth/register",
        "method": "POST",
        "description": "Attempt to register with an already-taken username and expect 400",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    {
        "name": "register_user_missing_fields",
        "category": "MISSING_REQUIRED",
        "endpoint": "/auth/register",
        "method": "POST",
        "description": "Attempt to register without required fields and expect 422 validation error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {}
    ...
    },
    {
        ...
        "endpoint": "/divide",
        "method": "POST",
        "description": "Attempt division by zero and expect 400 with 'Cannot divide by zero' message",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Create a new calculation record with valid auth and expect 201",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "GET",
        "description": "List all calculations with valid authentication and expect 200 with array",
        "request_data": {
            "path": {},
            "query": {},
            "body": null,

...
A REST API server providing authenticated calculator operations and calculation history, built with FastAPI, SQLModel, and SQLite.
...
| `CALC_API_ACCESS_TOKEN_EXPIRE_MINUTES` | Token expiration in minutes | `30` |
...
```json
{"id": 1, "username": "alice", "created_at": "2026-02-17T12:00:00.000000"}
```
...
Tests use an in-memory SQLite database and do not require any external services or configuration.
